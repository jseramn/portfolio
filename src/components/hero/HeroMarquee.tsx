...
import { CHROME_FOCUS, GLOW, MARQUEE_TYPE, TAP_TARGET } from "./chrome"
    ...
    >
      ...
      >
        <HeroMotionSlider ready={motionChrome}>
          ...
          {ghStats && (
            <span className={MARQUEE_TYPE}>
              {ghStats.today} contributions today · {ghStats.month} this month · {ghStats.year} this
              year · {ghStats.total} all-time
            </span>
          )}
