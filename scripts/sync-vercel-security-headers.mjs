...
export const PREVIEW_ASSET_SOURCE =
  "/(thumbnail.png|favicon.ico|favicon.png|favicon.svg|apple-touch-icon.png|site.webmanifest|android-chrome-192x192.png|android-chrome-512x512.png|oembed.json|ascii-poster.webp)"
